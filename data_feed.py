...
# تنظیمات پیش‌فرض بر اساس نیاز شما: ارز DASH و تایم‌فریم روزانه (1D)
...
def load_from_tradingview(
    ...
    df = tv.get_hist(
        ...
        interval=Interval.in_daily,  # تغییر به تایم‌فریم روزانه (1D)
        n_bars=n_bars,
...
def load_from_bingx(
    ...
    # تغییر مهم: فرمت روزانه در BingX به صورت "1d" (حروف کوچک) است
    interval = "1d"  
    limit = 1000
    ...
    # اطمینان از فرمت صحیح نماد برای BingX (مثلاً DASHUSDT -> DASH-USDT)
